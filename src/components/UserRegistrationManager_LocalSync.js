// User Registration Manager with Local Storage Sync
// This version syncs user data across devices using localStorage polling
...
function UserRegistrationManager() {
  ...
  const handleRefresh = () => {
    loadUsers();
    setSuccessMessage('✅ Refreshed from all devices!');
    ...
    <div className="w-full max-w-2xl mx-auto p-6 bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg border border-gray-700">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          title="Refresh from all devices"
        >
      ...
      <div className="mt-6 p-4 bg-blue-900 border border-blue-700 rounded-lg text-blue-200 text-sm">
        ...
        <ul className="list-disc list-inside space-y-1 text-xs">
          <li>Data syncs every 2 seconds across all tabs/devices</li>
          <li>Register on one device, see on another instantly</li>
          <li>Works on same WiFi network</li>
          <li>Data stored in browser storage</li>
          <li>No internet needed (works offline)</li>
        </ul>
      </div>
    </div>
  );
